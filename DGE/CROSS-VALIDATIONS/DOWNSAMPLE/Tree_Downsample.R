...
round(mean(sapply(rhemac_specific, nrow)))/25 #18.6

# TREE
n <- read.tree(text="(RheMac:18.6,(PanTro:11.3,Hsap:25.5):1);")
...
round(mean(sapply(rhemac_specific, nrow)))/25 #19.4

o <- read.tree(text="(RheMac:19.4,(PanTro:17.5,Hsap:37.8):1);")

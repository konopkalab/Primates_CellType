...
--gene-annot /U3/stefano/src/magma_v1.07/GENES/hg19_gencodeV19_magma_annotation.genes.annot \
--set-annot *.txt col=1,2 \
--pval /U5/Stefano/GWAS_DATABASE/ALZ_JENSEN_ForMagma.bed N=455258 \
--out ALZ_2019
...
--gene-annot /U3/stefano/src/magma_v1.07/GENES/hg19_gencodeV19_magma_annotation.genes.annot \
--set-annot *.txt col=1,2 \
--pval /U5/Stefano/GWAS_DATABASE/SCZvsCONT.sumstats.bed N=87491 \
--out SZ_2018
...
--gene-annot /U3/stefano/src/magma_v1.07/GENES/hg19_gencodeV19_magma_annotation.genes.annot \
--set-annot *.txt col=1,2 \
--pval /U5/Stefano/GWAS_DATABASE/HEIGHT_ForMagma.bed N=253288  \
--out zHGT
...
--gene-annot /U3/stefano/src/magma_v1.07/GENES/hg19_gencodeV19_magma_annotation.genes.annot \
--set-annot *.txt col=1,2 \
--pval /U5/Stefano/GWAS_DATABASE/BMI_ForMagma.bed N=100418  \
--out zBMI
